...
%\newcommand\Reader{Second Reader: David Drohan}
...
%\\Schema Fields: 
%\\\hspace*{2em}-field name: \q{writeSpeed}, fieldType: \q{double}
%\\\hspace*{2em}-field name: \q{tableName}, fieldType: \q{string}
%\\
...
\begin{figure}[H]
\begin{tcolorbox}
\centerline{\includegraphics[width=.9\textwidth]{js_agg_builder_flow_1}}
...
\begin{figure}[H]
\begin{tcolorbox}
\centerline{\includegraphics[width=.8\textwidth]{iris_kibana_single_entity}}
\end{tcolorbox}
