...
\subsection{MySQL}
The MySQL agent demonstrates how a user can monitor their database by converting the MySQL `performance\_schema' results into JSON and sending them to Iris.
\subsubsection{Description}
...
\end{minted}
\end{tcolorbox}
\caption{MySQL Agent, MySql `performance\_schema' table query used in iris-mysql.py source code}
\end{figure}

More information on the MySQL `performance\_schema' table can be found here \url{https://dev.mysql.com/doc/refman/5.6/en/performance-schema-quick-start.html}
