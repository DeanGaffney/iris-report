...
%Add description on how girdstack devs posted code to serialize the gird and widget positions, then explain how you expanded on that and added chart types and aggregation data to it
