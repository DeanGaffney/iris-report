...
\newcommand\Date{April 2018}
\newcommand\Report{Status Report (Semester 2)}

\usepackage{etoolbox}
\ifdef{\Reader}{}{\gdef\Reader{Dr.~Kieran Murphy (Supervisor)}}
...
\vfill
{\fontsize{14pt}{20pt}\selectfont \bfseries \Author (\StudentID)}
\vfill
%{\fontsize{14pt}{20pt}\selectfont \bfseries \StudentID\ --- Panel 5}
\vfill
{\fontsize{14pt}{20pt}\selectfont \bfseries Panel 5 --- \Reader}
\vfill
...
The following section is identical to the Motivation for Iris section in the Semester 1 report. It has been included here for convenience.
...
For a basic demo of Gridstack.js refer to \url{http://gridstackjs.com/demo/}
...
For more information on the Grails 3 `grails-spring-websocket' plugin refer to \url{https://github.com/zyro23/grails-spring-websocket}.
\begin{figure}[H]
\begin{tcolorbox}
...
\end{center}
A screenshot of the Node.js dashboard in Iris capturing its fifth revision. Note the extra chart `OS Types' that was added to this revision compared to the fourth revision shown in \cref{fig:dash:rev:4}.
\end{tcolorbox}
...
For more information on the EC2 instance types refer to \url{https://aws.amazon.com/ec2/instance-types/}.
...
For more information on Jetty refer to \url{https://www.eclipse.org/jetty/documentation/9.4.x/introduction.html}.
...
\end{itemize}
A full list of all the obtainable attributes through `systeminformation' can be found at \url{https://github.com/sebhildebrandt/systeminformation}.
...
For more information on Selenide see their site \url{http://selenide.org/}
