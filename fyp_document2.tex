...
By end of semester 1 the javascript libraries that will be used were selected but only basic testing of features was carried out.  In this semester the dasdbards were designed and implemented.
...
and number of examples of datasource are discussed. THe Implementation details of these data sources is not covered in detail basuace they are not germane to the this project and follow well knowe patterns.
